...
var scriptDirectory = ENVIRONMENT_IS_WORKER ? new URL("litert-wasm/", self.location.href).href : "";
...
if (ENVIRONMENT_IS_WEB || ENVIRONMENT_IS_WORKER) {
  try {
    scriptDirectory = ENVIRONMENT_IS_WORKER ? new URL("litert-wasm/", self.location.href).href : new URL(".", _scriptName).href;
  } catch {}
  {
